...
# Input model for the FastAPI request
...
def split_by_chapters_and_chunks(text, chunk_size=200):
    ...
    for i in range(1, len(chapters), 2):
        ...
        # Document object for each chunk and assign chapter metadata
        for chunk in chunks:
...
sample_text = docs[3].page_content[:500]
...
async def query_rag(request: QueryRequest):
    ...
    # Retrieval and question-answer chain
